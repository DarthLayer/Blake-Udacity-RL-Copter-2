...
class Actor:
    ...
    def build_model(self):
        ...
        # Add hidden layers
        net = layers.Dense(units=1000,kernel_regularizer=layers.regularizers.l2(1e-6))(states)
...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=1000,kernel_regularizer=layers.regularizers.l2(1e-6))(states)
